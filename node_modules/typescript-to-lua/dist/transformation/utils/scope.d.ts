...
export declare function findAsyncTryScopeInStack(context: TransformationContext): Scope | undefined;
/** Like findAsyncTryScopeInStack, but also stops at Loop boundaries. */
export declare function findAsyncTryScopeBeforeLoop(context: TransformationContext): Scope | undefined;
